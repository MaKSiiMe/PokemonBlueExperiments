...
ROM_PATH = os.path.join(os.path.dirname(__file__), "..", "..", "PokemonBlue.gb")
INIT_STATE = os.path.join(os.path.dirname(__file__), "..", "..", "init.state")

def input_thread(pyboy):
    """Thread séparé pour gérer les inputs sans bloquer PyBoy"""
    print("\n--- INSTRUCTIONS ---")
    print("1. Joue normalement dans la fenêtre.")
    print("2. Quand tu es à un endroit cool, tape 's' + ENTRÉE dans ce terminal.")
